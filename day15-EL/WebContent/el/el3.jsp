...
http://localhost:8081/day15-EL/el/el3.jsp?name=&address=&id=<br/>
name, address, id는 요청 파라미터의 키이다
 
<h3>EL의 다중 파라미터 처리: paramValues</h3>
<pre>
paramValues로 파라미터를 추출하면 배열로 받아짐
따라서 배열 인덱스를 나타내는 [숫자]로 접근이 가능하다
...
<h3>scriptlet, expression Tag를 사용한 다중 파라미터 처리: getParameterValues()</h3>
<%
